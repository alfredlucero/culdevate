...
const OrganizationsEmptyCard: React.FC<RecapEmptyCardProps> = ({
  ...
  return (
    <RecapEmptyCard.EmptyCard className={className} testId={testId} {...passThroughProps}>
      <RecapEmptyCard.Icon kind={RecapKind.Organizations} className="mb-6 flex justify-center" />
      <RecapEmptyCard.Kind kind={RecapKind.Organizations} className="mb-4 text-center" />
