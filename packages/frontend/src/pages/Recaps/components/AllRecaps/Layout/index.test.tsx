...
import AllRecapsLayout, { AllRecapsLayoutProps } from "./index";
...
const defaultProps: AllRecapsLayoutProps = {
  recapsMap: {
...
describe("<AllRecapsLayout />", () => {
  test("should render without error", () => {
    const { container } = render(<AllRecapsLayout {...defaultProps} />);
  ...
  test("should show the empty state when there are no recaps", () => {
    ...
    expect(queryByText("Accomplishments")).toBeNull();
    expect(queryByText("Organizations")).toBeNull();
    expect(queryByText("Skills")).toBeNull();
    expect(queryByText("Side Projects")).toBeNull();
    expect(queryByText("Publications")).toBeNull();
    expect(queryByText("References")).toBeNull();
    expect(queryByText("Other")).toBeNull();

    expect(getByTestId("allRecapsEmptyCard")).toBeVisible();
  });
});
